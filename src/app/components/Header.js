    ...
    return (
        <header className='py-4'>
            <div className='mx-10 sm:mx-auto max-w-6xl px-4 flex items-center justify-between border border-zinc-600 p-3 rounded-full'>
                {/* Left part */}
                <div>
                    <span className='text-xl text-white cursor-pointer font-bold ml-2'>Samavia
                        <span className='text-slate-400 font-bold'>Shahid</span></span>
                </div>
                {/* Mid part */}
                ...
                <div className='flex space-x-3 items-center'>
                    ...
                    <button className='border cursor-pointer border-gray-500 px-4 py-2 rounded-full text-white'>GitHub</button>
