...
function Experience() {
  ...
  return (
    <>
      <h3 className="lg:tracking-[20px] tracking-[12px] mx-auto text-center mb-10 uppercase text-gray-400 text-2xl">
        Experience
      </h3>

      <div className="max-w-6xl mx-auto px-6 lg:px-0 grid grid-cols-1 lg:grid-cols-3 mt-8 mb-20">
        {posts?.map((item, index) => (
          <div
            className="bg-slate-400 p-6 rounded-lg shadow-md mx-4 lg:mb-0 mb-8"
            key={index}
          >
